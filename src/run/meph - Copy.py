...
class Meph:
    ...
    def battle(self, do_pre_buff: bool) -> Union[bool, tuple[Location, bool]]:
        ...
        template_match = self._template_finder.search_and_wait(["MEPH_WP"], threshold=0.65, time_out=20).valid
        ...
        found = False
        while not found:
            found = self._template_finder.search_and_wait(["PURPENT2"], threshold=0.9, time_out=0.1, take_ss=False, use_grayscale=False).valid 
            if not found:
                dinky = 1
                while dinky < 100:
